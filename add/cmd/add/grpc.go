...
import (
	...
	addsvr "add/gen/grpc/add/server"
	"context"
	"log"
	"net"
	"net/url"
...
func handleGRPCServer(ctx context.Context, u *url.URL, addEndpoints *add.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		addServer = addsvr.New(addEndpoints, nil)
	}
	...
	addpb.RegisterAddServer(srv, addServer)
