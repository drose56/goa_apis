...
import (
	...
	pokesvr "poke/gen/grpc/poke/server"
	poke "poke/gen/poke"
	"sync"
...
func handleGRPCServer(ctx context.Context, u *url.URL, pokeEndpoints *poke.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		pokeServer = pokesvr.New(pokeEndpoints, nil)
	}
	...
	pokepb.RegisterPokeServer(srv, pokeServer)
