...
import (
	...
	newpokesvr "new_poke/gen/grpc/new_poke/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, newPokeEndpoints *newpoke.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		newPokeServer = newpokesvr.New(newPokeEndpoints, nil)
	}
	...
	new_pokepb.RegisterNewPokeServer(srv, newPokeServer)
